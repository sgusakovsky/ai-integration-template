...
Рекомендуемая модель — не «добавить AI в репозиторий проекта», а создать **внешний AI-контур разработки**, который помогает команде производить обычные, проверяемые и поддерживаемые инженерные результаты.
...
Репозиторий проекта не должен содержать служебные AI-артефакты:

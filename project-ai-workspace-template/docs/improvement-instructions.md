...
7. Validate structure and behavior. A wording match is not a behavioral evaluation.
8. Do not commit, push, merge, publish, install, or deploy. A human reviews and delivers the AI-workspace change.

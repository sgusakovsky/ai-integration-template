...
- [ ] Approved intent matches actual behavior.
- [ ] No silent assumptions or scope expansion.
- [ ] Existing architecture and conventions are followed.
- [ ] Authentication, authorization, validation, errors, and logging are correct.
- [ ] Tests use an independent behavioral oracle.
